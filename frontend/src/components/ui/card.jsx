...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[calc(var(--radius)+0.35rem)] border border-border/70 bg-card/78 text-card-foreground shadow-[0_28px_60px_-42px_rgba(15,23,42,0.55)] ring-1 ring-white/[0.03] backdrop-blur-xl",
      className
    )}
    {...props} />
))
